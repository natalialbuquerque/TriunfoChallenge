...
extension Movie {
    ...
    static let urlComponents = URLComponents(string: "https://api.themoviedb.org/")! // essa variável nao é uma string, é do tipo URLComponents
...
// nao precisa se preocupar tanto com a implementaçao desse código
